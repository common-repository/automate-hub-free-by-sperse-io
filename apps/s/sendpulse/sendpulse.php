...
function awp_sendpulse_settings_view( $current_tab ) {
    ...
    <a href="https://sperse.io/go/sendpulse" target="_blank"><img src="<?php echo esc_url(AWP_ASSETS.'/images/logos/sendpulse.png'); ?>" width="330" height="50" alt="Sendpulse Logo"></a><br/><br/>
    <?php 
                ...
                ?>
                <br/>   
    <form name="sendpulse_save_form" action="<?php echo  esc_url( admin_url('admin-post.php')) ; ?>" method="post" class="container">
        <input type="hidden" name="action" value="awp_save_sendpulse_api_key">
        <input type="hidden" name="_nonce" value="<?php echo wp_create_nonce( "awp_sendpulse_settings" ) ;?>"/>
        ...
        <table class="form-table">
            <tr valign="top">
                ...
                <td>
                    ...
                    <input type="text" name="awp_sendpulse_display_name" id="awp_sendpulse_display_name" value="<?php echo esc_attr($display_name) ?>" placeholder="<?php esc_html_e( 'Enter Display name', 'automate_hub' ); ?>" class="basic-text"/>
                    <span class="spci_btn form-table__input-btn" data-clipboard-action="copy" data-clipboard-target="#awp_sendpulse_display_name"><img src="<?php echo esc_url(AWP_COPY_ICON); ?>" alt="Copy to clipboard"></span>
                    </div>
                </td>
            </tr>
            <tr valign="top">
                <th scope="row"> <?php _e( 'ID', 'automate_hub' ); ?></th>
                <td>
					<div class="form-table__input-wrap">
					<input type="text" name="awp_sendpulse_id" value="<?php echo esc_attr($client_id); ?>" placeholder="<?php _e( 'Please enter ID', 'automate_hub' ); ?>" class="basic-text"/>
                    <span class="spci_btn" data-clipboard-action="copy" data-clipboard-target="#awp_sendpulse_id"><img src="<?php echo esc_url(AWP_COPY_ICON); ?>" alt="Copy to clipboard"></span>
                </div></td>
            </tr>
            <tr valign="top">
                <th scope="row"> <?php _e( 'Secret', 'automate_hub' );?></th>
                <td>
					<div class="form-table__input-wrap">
					<input type="text" name="awp_sendpulse_secret" id="awp_sendpulse_secret" value="<?php echo esc_attr($client_secret); ?>" placeholder="<?php _e( 'Please enter Secret', 'automate_hub' ); ?>" class="basic-text"/>
                    <span class="spci_btn" data-clipboard-action="copy" data-clipboard-target="#awp_sendpulse_secret"><img src="<?php echo esc_url(AWP_COPY_ICON); ?>" alt="Copy to clipboard"></span></div>
                </td>
            </tr>
        </table>
...
add_action( 'awp_action_fields', 'awp_sendpulse_action_fields' );
